 ...
 * show all the song availibe to the user to be
...
public class JukeboxGUI extends Application {
	...
	/**
	 * this will add song object to an obserable list of songs so that the table
	...
	/**
	 * this will handel the action event for when the user want to add a song to the
	 * queue
	 */
